#ifndef __bayesian_simultaneous_changepoint_normal_var_model_hpp__
#define __bayesian_simultaneous_changepoint_normal_var_model_hpp__

#include "base.hpp"

namespace bayesian_simultaneous_changepoint {

    class NormalVarModel {
        private:
            double mu0;
            double a;
            double b;
        ...
        public:
            NormalVarModel(const ModelParams& params);
            void add_data(double x);
            void remove_data(double x);
            void clear();
            void combine(const NormalVarModel& other);
            double logmarginal();
